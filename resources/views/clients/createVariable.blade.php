        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Create Variable</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Ecommerce</a></li>
                            <li class="breadcrumb-item active">Create Variable</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="product_id" name="product_id" value=""
                                        placeholder="Enter product product_id" required>
                                    <div class="invalid-feedback">Please Enter a product product_id.</div>
                                </div>
                                <div class="mb-3">
                                    {{-- <label class="form-label" for="attribute_id">Attribute ID</label>
                                    <input type="text" class="form-control" id="attribute_id" name="attribute_id" value=""
                                        placeholder="Enter product attribute_id" required>
                                    <div class="invalid-feedback">Please Enter a product attribute_id.</div> --}}
